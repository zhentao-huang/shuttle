package com.trendmicro.mobilelab.toolbox.container.deployer;
...
public class AndroidContextDeployer extends AbstractLifeCycle {
    ...
    protected void doStart() throws Exception {
        ...
        Log.debug("AndroidContextDeployer doStart()");
        ...
        Log.debug("AndroidContextDeployer doStart() done");
    }
    ...
    protected void doStop() throws Exception {
        ...
        Log.debug("AndroidContextDeployer doStop()");
    }
