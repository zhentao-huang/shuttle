...
import com.trendmicro.mobilelab.toolbox.container.deployer.AndroidContextDeployer;
import com.trendmicro.mobilelab.toolbox.container.deployer.AndroidWebAppDeployer;
import com.trendmicro.mobilelab.toolbox.handler.DefaultHandler;
...
//    private static final String JETTY_SERVER_ATTRIBUTE = "com.trendmicro.mobilelab.toolbox.jetty";
    ...
    public static final String[] __configurationClasses = 
        new String[]
        {
            "com.trendmicro.mobilelab.toolbox.container.webapp.AndroidWebInfConfiguration",
...
//                contextDeployer.setAttribute(JETTY_SERVER_ATTRIBUTE, getServer());
    ...
    protected void startJetty() throws Exception
    {
        ...
        Log.d(TAG, "Config Connectors");
        configureConnectors();
        Log.d(TAG, "Config Handlers");
        configureHandlers();
        Log.d(TAG, "Config Deployers");
        configureDeployers();
        Log.d(TAG, "Config Realm");
        configureRealm ();
        Log.d(TAG, "Start Server");
    
        server.start();
        
        Log.d(TAG, "Started Jetty Server");
